...
def layout():
    return dbc.Container(
        children=[
            ...
            dbc.Row(
                children=[
                    dbc.Col(dcc.Markdown("""# ***Welcome to Tree House Explorer!*** """, className="homepage-title"), align='center'),
                ],
                id="homepage-row",
                no_gutters=True,
                key='updates-row',
                    ...
                    dbc.Col(
                        children=[
                            ...
                            dbc.Col(
                                dbc.Card(
                                    children=[
                                        html.Div([dbc.CardImg(src=app.get_asset_url("docs4.svg"), top=True, className="homepage-card-image")], style={"padding": "5px"}),
                                        dbc.CardBody([dbc.Button("Docs", block=True, className="homepage-buttons", color="info", outline=True, href="/apps/documentation"),]),
                                    ],
                                    color="warning",
                                    outline=True,
                                ),
                            ...
                            dbc.Col(
                                dbc.Card(
                                    children=[
                                        html.Div([dbc.CardImg(src=app.get_asset_url("github.svg"), top=True, className="homepage-card-image")], style={"padding": "5px"}),
                                        dbc.CardBody(
                                            children=[
                                                dbc.Button("GitHub", block=True, className="homepage-buttons", color="info", outline=True, href="https://github.com/harris-2374/THEx", target="_blank",),
                                            ],
                                        ),
                                    ],
                                    color="warning",
